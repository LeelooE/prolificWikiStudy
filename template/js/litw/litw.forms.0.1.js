 ...
 *
 * Author: Maria Tracy
 * Code Template authopr: Trevor Croxson
 *
...

{
    "forms":{
        "generic":{
            "headerMessage": "Please fill out the form below:",
            "whyPrompt":"Why?",
            "whyMessage":"The information you provide will help us analyze your results.",
            "requiredMessage":"Fields marked with a * are required.",
            "requiredMessageAll":"Please answer all questions below.",
            "autofillMessage":"I am on a personal computer.",
            "autofillWhyPrompt":"Why?",
            "autofillWhyMessage":"If you are on a personal computer, we will store your demographics information on your local machine. This will allow you to skip the demographics form on any other LabintheWild tests that you might take. If you'd prefer not to have a saved copy, simply leave the box unchecked."
        },
        "demographics":{
            "headerMessage":"Please tell us a bit about yourself.",
            "whyMessage":"We need this information for data analysis. Please note that none of the answers are personally identifiable. LabintheWild takes your privacy very seriously. You may email us at info@labinthewild.org for more information."
        },
        "comments":{
            "headerMessage":"Thanks for your participation! If you have a minute, please answer the questions below."
        }
    },
    "formElements":{
        "generic":{
            "expansionHeader":"Please add additional information below.",
            "expansionPrompt":["Next item:"],
            "expandPrompt":"[Add Another]",
            "contractPrompt":"[Delete]"
        },
        "retake":{
        ...
        "multinational":{
            "prompt":"Have you lived in more than one country?"
        },
        "country":{
            "prompt":"What country do you live in?",
            "expansionHeader":"Please add countries in order from the country you were born in to the most recent.",
            "expansionPrompt":["First Country:","Next Country:"],
            "expandPrompt":"[Add Another Country]",
            "contractPrompt":"[Delete]"},
            "years":{
                "prompt":"How many years did you live there?",
                "boundsMessage":"Have you really lived there for %s years? If not, please make sure to enter the correct value so that your data contributes to our research."
            },
            "father":{
                "prompt":"What is your father's nationality?"
            },
            "mother":{
                "prompt":"What is your mother's nationality?"
            },
            "age":{
                "prompt":"How old are you?",
                "invalidMessage":"Please enter a number between 5 and 99"
            },
            "education":{
                "prompt":"What is the highest level of education you have received or are pursuing?"
            },
            "language":{
                "prompt":"What is your native language?"
            },
            "proficiency":{
                "prompt": "What is your English reading proficiency? (1 meaning you have little to no proficiency, 5 meaning expert/native proficiency)"
            }, 
            "cheating":{
                "prompt":"Did you cheat or receive outside assistance?"
            },
            "cheatingComments0":{
                "prompt":"Please explain in the box below:",
                "placeholderText":"You may leave this area blank.",
                "expansionHeader":["Please describe how you cheated or received assistance:"]
            },
            "technical":{
                "prompt":"Did you experience any technical difficulties?"
            },
            "technicalComments0":{
                "prompt":"Please explain in the box below:",
                "placeholderText":"You may leave this area blank.",
                "expansionHeader":["Please describe your technical difficulties:"]
            },
            "generalComments":{
                "prompt":"Please leave any other comments you have below:",
                "placeholderText":"You may leave this area blank."}
            },
            "dropdownOptions":{
                "countries":[
                    ...
                    {"label":"The Democratic Republic Of The Congo","value":"The Democratic Republic Of The Congo"},
        ...
        properties = {
            forms: {
                ...
                demographics: {
                    ...
                    requiredQuestions: ["retake", "age", "country", "language"],
            ...
            formElements: {
                ...
                proficiency: {
                    ...
                    options: "proficiency",
                    expandable: true,
                    prompt: C.formElements.proficiency.prompt
                },
                years: {
                    name: "years",
