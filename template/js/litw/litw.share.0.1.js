...
(function( exports ) {
  ...
  var properties = {
    ...
    title: "What percentage of Wikipedia do you know?",
    // short description of the experiment (needed by LinkedIn)
    description: "Take a survey on a few Wikipedia articles to see how well and fast you learn things.",
  ...
  makeButtons = function(selector, twitterText) {
    properties.title = properties.title || $('meta[property="og:title"]').attr('content') || "A Test on LabintheWild";
      ...
      $(this).html(_makeButtonsHelper(i, twitterText));
    });
  ...
  _makeButtonsHelper = function(count, twitterText) {
    var URItitle = encodeURIComponent(twitterText);
    ...
    var imgUrl = encodeURIComponent("https://www.labinthewild.org/studies/wikipedia/wikiscore/wikiscore-1.png"|| $('meta[property="og:url"]').attr('content'));
